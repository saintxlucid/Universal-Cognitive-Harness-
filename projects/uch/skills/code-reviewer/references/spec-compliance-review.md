...
```
      ...
      â”‚   âœ— Issues    â”‚                â”‚   âœ“ Compliant   â”‚
      â”‚     Found     â”‚                â”‚                 â”‚
      â””â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”˜                â””â”€â”€â”€â”€â”€â”€â”€â”€â”¬â”€â”€â”€â”€â”€â”€â”€â”€â”˜
              ...
              â”‚            â”‚   âœ— Issues    â”‚         â”‚   âœ“ Approved    â”‚
              â”‚            â”‚     Found     â”‚         â”‚                 â”‚
...
**Status:** âŒ Incomplete - minimum length validation missing
```
...
**Status:** âš ï¸ Scope creep - discuss before merging
```
...
**Status:** â“ Clarify - which sort order was intended?
```
...
```markdown
## Spec Compliance Review: âœ… PASS

All requirements verified:
- âœ… User can upload profile image (req #1)
- âœ… Image resized to 200x200 (req #2)
- âœ… Invalid formats rejected with error message (req #3)
- âœ… Progress indicator during upload (req #4)
...
```markdown
## Spec Compliance Review: âŒ ISSUES FOUND
