...
<!-- Reference documentation for the skill context-management workflow. -->
...
The context window is a scarce resource â€” an **attention budget**. Every token consumes attention capacity. Irrelevant tokens actively degrade performance.
...
| Format conversion (verbose JSON to compact YAML/CSV) | Moderate (15-30%) | Medium â€” verify parsability |
| Extractive summarization of history | High (30-50%) | Medium â€” potential information loss |
...
- For prompt pattern selection (zero-shot, few-shot, CoT) â€” see `prompt-patterns.md`
- For token counting and A/B testing mechanics â€” see `prompt-optimization.md`
- For system prompt structure and persona design â€” see `system-prompts.md`
- For structured output schemas â€” see `structured-outputs.md`

---

## Related Skills

- **RAG Architect** â€” Vector search, chunking, and retrieval pipeline design
- **Architecture Designer** â€” System-level context flow in multi-agent architectures
- **Debugging Wizard** â€” Diagnosing agent behavior failures that may be context-related
